...
TOKEN = '7488045186:AAHMZA9GNuXDuQzVZqZXEwJ-_r1bIoDpjqQ'
...
FORWARD_CHANNEL_ID = -1002240699126
CHANNEL_ID = -1002240699126
error_channel_id = -1002240699126
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/DdosAnonymous*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact admin @AnonymousHcks*", parse_mode='Markdown')
    else:
